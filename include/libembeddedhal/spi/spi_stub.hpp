 ...
 * drivers that require an optional spi interface. This implementation should only
 * be used when a driver has stated in its documentation that the spi interface is
