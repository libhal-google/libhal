...
struct nanoradian
  : units::
      prefixed_unit<nanoradian, units::isq::si::nano, units::radian>
{};
...
struct microradian
  : units::
      prefixed_unit<microradian, units::isq::si::micro, units::radian>
{};
...
struct milliradian
  : units::
      prefixed_unit<milliradian, units::isq::si::milli, units::radian>
{};
